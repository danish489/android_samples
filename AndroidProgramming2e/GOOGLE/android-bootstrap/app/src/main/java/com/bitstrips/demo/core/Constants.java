...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.bitstrips.demo";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "BitStripsDemo";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.bitstrips.demo.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.bitstrips.demo.";
