...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-bitstrips-demo.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-bitstrips-demo)

This repository contains the source code for the [BitStripsDemo](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.bitstrips.demo).

Please see the [issues](https://github.com.bitstrips.demo/com-bitstrips-demo/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about BitStripsDemo? Ask away on the [com-bitstrips-demo discussion forum](https://groups.google.com/forum/#!forum/com-bitstrips-demo).

<a href="https://play.google.com/store/apps/details?id=com.bitstrips.demo" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.bitstrips.demo__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.bitstrips.demo__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.bitstrips.demo.R__) will now be renamed
...
signed with a different key.  Manually uninstall BitStripsDemo from your device and
...
BitStripsDemo is a result of a template project I've developed over the years as well as
...
BitStripsDemo is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.bitstrips.demo/com-bitstrips-demo/contributors) on
...
[pull requests](https://github.com.bitstrips.demo/com-bitstrips-demo/pulls).
